...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.imageView = GraphicsView(self.centralwidget)
        ...
        self.labelChecked = QtWidgets.QAction(MainWindow)
        self.labelChecked.setCheckable(True)
        self.labelChecked.setChecked(True)
        self.labelChecked.setObjectName("labelChecked")
        self.maskChecked = QtWidgets.QAction(MainWindow)
        self.maskChecked.setCheckable(True)
        self.maskChecked.setObjectName("maskChecked")
        self.predictChecked = QtWidgets.QAction(MainWindow)
        self.predictChecked.setCheckable(True)
        self.predictChecked.setObjectName("predictChecked")
        ...
        self.menu_V.addAction(self.labelChecked)
        self.menu_V.addAction(self.maskChecked)
        self.menu_V.addAction(self.predictChecked)
        self.menubar.addAction(self.menu_F.menuAction())
        self.menubar.addAction(self.menu_V.menuAction())

        self.retranslateUi(MainWindow)
        self.exitAction.triggered.connect(MainWindow.close)
        self.openAction.triggered.connect(MainWindow.openDICOM)
        self.labelAction.triggered.connect(MainWindow.openLabel)
        self.setWindowAction.triggered.connect(MainWindow.showSetWindow)
        self.imageSlider.valueChanged['int'].connect(MainWindow.sliceChanged)
        self.imageSpinBox.valueChanged['int'].connect(MainWindow.sliceChanged)
        self.imageView.cutFinished.connect(MainWindow.cropped)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.maskAction.setText(_translate("MainWindow", "取得掩模"))
        self.labelChecked.setText(_translate("MainWindow", "显示标签"))
        self.maskChecked.setText(_translate("MainWindow", "显示掩模"))
        self.predictChecked.setText(_translate("MainWindow", "预测肿瘤"))
