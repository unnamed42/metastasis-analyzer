...
from app.controls.GraphicsView import GraphicsView
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.triggerLungSeg = QtWidgets.QAction(MainWindow)
        self.triggerLungSeg.setCheckable(True)
        self.triggerLungSeg.setObjectName("triggerLungSeg")
        ...
        self.menu_V.addAction(self.triggerLungSeg)
        self.menu_V.addAction(self.predictAction)
        self.menubar.addAction(self.menu_F.menuAction())
        self.menubar.addAction(self.menu_V.menuAction())

        self.retranslateUi(MainWindow)
        self.exitAction.triggered.connect(MainWindow.close)
        self.labelAction.triggered.connect(MainWindow.on_openLabel)
        self.setWindowAction.triggered.connect(MainWindow.on_setWindow)
        self.imageSlider.valueChanged['int'].connect(MainWindow.on_sliceChanged)
        self.imageSpinBox.valueChanged['int'].connect(MainWindow.on_sliceChanged)
        self.predictAction.triggered.connect(MainWindow.on_predict)
        self.openAction.triggered.connect(MainWindow.on_openDICOM)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.triggerLungSeg.setText(_translate("MainWindow", "提取肺实质"))
        self.predictAction.setText(_translate("MainWindow", "选取区域并识别"))
